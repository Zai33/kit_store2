        ...
        <div className="flex bg-slate-800 gap-y-10 px-16 py-10">
          <div className=" w-1/2">
            ...
            <p className=" text-white font-roboto">
              ...
              shopping experience by providing a seamless interface where
              sellers connect with buyers, fostering a sustainable cycle of
              reuse and giving pre-loved items a new lease on life."
            </p>
          </div>
